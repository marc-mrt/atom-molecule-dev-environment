    ...
    .mergeMap((action: RunTaskAction) => {
      return Rx.Observable.create(async observer => {
        ...
        try {
          ...
          connection.onNotification("capabilities", (capabilities) => {
            if (capabilities.completionProvider && capabilities.completionProvider.resolveProvider) {
              eventEmitter.register(taskID, "textDocument/completion", () => {} /* data => {
                return languageClientConfig.connection.sendRequest(
