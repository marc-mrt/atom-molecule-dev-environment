...
import eventEmitter from "../../CompletionFeature/Model/EventEmitter";
    ...
    .mergeMap((action: RunTaskAction) => {
      return Rx.Observable.create(async observer => {
        ...
        try {
          ...
          taskID = context.molecule.generateTaskID();
          ...
          if (
            ...
            initializeResult.capabilities.completionProvider.resolveProvider
          ) {
            console.log("should register for textDocument/completion");
            eventEmitter.register(taskID, "textDocument/completion", data => {
              console.log(data);
              return connection
                .sendRequest("textDocument/completion", data)
                .then(r => console.log("response came", r));
            });
          }
        ...
        return function unsubscribe() {
          ...
          eventEmitter.unregister(taskID);
        };
      });
    })
    .share()
