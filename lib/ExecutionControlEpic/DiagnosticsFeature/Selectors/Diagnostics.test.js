...
import { selectDiagnosticsOfTask, selectAllDiagnostics } from "./Diagnostics";
...
describe("Diagnostics Selectors", () => {
  ...
  describe("selectAllDiagnostics", () => {
    it("should return a list version of the diagnostics", () => {
      let diagnostics: DiagnosticsReducer = Map([
        [
          "1",
          Map([
      ...
      let subject = selectAllDiagnostics(diagnostics);
